...
waypoints = [0 50; 150 50; 300 75; 310 75; 400 0; 300 -50; 290 -50; 20 -50]; % in meters
...
speedLimit = 12; % in meters/second

% Minimum distance the planner should target for following behavior.
safetyGap = 15; % in meters

[scenarioViewer,futureTrajectory,actorID,actorPoses,egoID,egoPoses,stepPerUpdate,egoState,true,lineHandles] = ...
...
while true
    ...
    [curActorState,futureTrajectory,true] = ...
